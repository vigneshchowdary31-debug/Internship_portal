...
class GoogleService {
    static getAuthClient() {
        ...
        try {
            ...
            return new googleapis_1.google.auth.JWT(credentials.client_email, undefined, credentials.private_key, SCOPES);
        }
        catch (error) {
    ...
    static async createMeetEvent(title, description, startTime, endTime) {
        ...
        if (!auth) {
            ...
            return {
                ...
                meetLink: `https://meet.google.com/mock-${(0, uuid_1.v4)().substring(0, 10)}`,
            };
        }
